...
db <- data.frame(readxl::read_excel("/Users/fsanta/Documents/PE_2025/db_CANAPRO_29_01_2025.xlsx", sheet = "base_datos")) %>% 
...
db <- db %>% dplyr::mutate(
                    ...
                    VEA0 = saldo_deuda - saldo_aportes_sociales1 - saldo_ahorros_permanentes1,
...
write.xlsx(x = df_list , file = "/Users/fsanta/Documents/PE_2025/PE_CANAPRO_30_01_2025.xlsx", rowNames = FALSE)

sum(c_libranza$PE) + sum(s_libranza$PE)
